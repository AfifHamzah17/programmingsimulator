...
<head>
    ...
    <title>Programming Simulator</title>
    ...
    <link rel="stylesheet" href="assets/css/php-einfach-online-php-editor.css" />
    <!--
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="scroll-to-section"><a href="structure.php">Structure</a></li>
                            <!-- <li class="scroll-to-section"><a href="#about">Editor</a></li> -->
                            <li class="scroll-to-section"><a href="tutorial.php">Tutorial</a></li>
                            <!-- <li class="scroll-to-section"><a href="#portfolio">Portfolio</a></li>  -->
                            <li class="scroll-to-section"><a href="editor.php">Editor</a></li>
